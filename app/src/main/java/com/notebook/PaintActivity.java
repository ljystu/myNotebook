...
import com.notebook.view.PaintView;
...
public class PaintActivity extends Activity {
    ...
    public void InitPaintMenu() {
        ...
        paint_bottomMenu.setNumColumns(paintItems.length);//设置列的个数
        paint_bottomMenu.setSelector(R.drawable.bottom_item);//背景透明？
        ...
        paint_bottomMenu.setAdapter(mAdapter);//用适配器将按钮放入bottomMenu中
    }
